	...
	switch (set) {
		...
		case 1: // country or nationality set
			if (searchValues.countrySet) {
				ui->frame->setStyleSheet("#frame { border-color: rgb(4, 171, 147);"
				                         "background-color: rgb(0, 255, 127);}");
				setToolTip("Program will search for players in this country");
			}
			else {
				ui->frame->setStyleSheet("#frame { border-color: rgb(1, 83, 164);"
		...
		case 2: // country and nationality set
			ui->frame->setStyleSheet("#frame { border-color: rgb(236, 27, 36);"
