...
void SearchDialog::updateValues()
{
	...
	if (ui->saveDefaultCountry->isChecked()) {
		Settings::checkedDivisions[0] =
		        ui->div1Check->isChecked() && !ui->div1Check->isHidden();
		Settings::checkedDivisions[1] =
		        ui->div2Check->isChecked() && !ui->div2Check->isHidden();
		Settings::checkedDivisions[2] =
		        ui->div3Check->isChecked() && !ui->div3Check->isHidden();
		Settings::checkedDivisions[3] =
		        ui->div4Check->isChecked() && !ui->div4Check->isHidden();
		Settings::checkedDivisions[4] =
		        ui->div5Check->isChecked() && !ui->div5Check->isHidden();
		Settings::checkedDivisions[5] =
		        ui->div6Check->isChecked() && !ui->div6Check->isHidden();
	...
	if (ui->saveDefaultNationality->isChecked()) {
		...
		Settings::sal =
		        qMakePair((quint32)ui->salMin->value(), (quint32)ui->salMax->value());
		Settings::dmi =
		        qMakePair((quint32)ui->dmiMin->value(), (quint32)ui->dmiMax->value());
		emit updateDefaultValues();
	}
}
